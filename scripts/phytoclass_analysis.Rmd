...
results <- create_complete_phytoclass_setup("min_chem_100_noc1c2_pras_lit.csv",
                                            "max_chem_100_noc1c2_pras_lit.csv")
...
write.csv(cluster_summary, here("summaries", "stats_manu_inputs_100_all_seasons_no_c1c2_2025-07-23_GA_lit.csv"),
          row.names = FALSE)
```
...
write.csv(combined_f_matrices, here("summaries", "out_matrix_manu_inputs_100_all_seasons_no_c1c2_2025-07-23_GA_lit.csv"),
          row.names = FALSE)

write.csv(pigment_variation, here("summaries", "out_variation_manu_inputs_100_all_seasons_no_c1c2_2025-07-23_GA_lit.csv"),
          row.names = FALSE)
...
write.csv(output_dm, here("outputs", "manu_inputs_100_all_seasons_no_c1c2_2025-07-23_GA_lit.csv"))
```
