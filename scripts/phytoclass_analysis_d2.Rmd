...
write.csv(cluster_summary, here("summaries", "stats_min_lit_d2.csv"),
          row.names = FALSE)
```
...
write.csv(combined_f_matrices, here("summaries", "out_matrix_min_lit_d2.csv"),
          row.names = FALSE)

write.csv(pigment_variation, here("summaries", "out_variation_min_lit_d2.csv"),
          row.names = FALSE)
