...
p <- read.csv(here("outputs", "manu_inputs2_2025-07-17_2.csv"))
...
ggsave(here("figures", "pc_chem_2025-07-18_seaonal_500.png"), plot = p,
...
save_kable(formatted_table, here("figures",
                                 "comparison_table_chem_manu_seasonal_500.png"), zoom = 2)
...
ggsave(here("figures", "phytoplankton_comparison_microscopy_phytoclass_2019_all_2025-07-17_2.png"),
       plot = m1,
       width = 12, height = 8, dpi = 300, bg = "white")
```
